...
{ 
    register_setting( 'my-own-theme-options-for-footer', 'footer_designby_text' );
}
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <style type="text/css">
                                #footer_designby_text{
                                        height:150px;
                                }
                        </style>
                        
                        <label for="my_footer_text">Footer Design By Text</label>
                        <?php
                            $content = get_option('footer_designby_text');
                            $editor_id = 'footer_designby_text';
